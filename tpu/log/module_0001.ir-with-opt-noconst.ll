...
@buffer_for_constant_24 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 64
@buffer_for_constant_30 = external local_unnamed_addr addrspace(1) constant [4 x i8], align 64
...
reduce-window.0.loop_exit.window.3.us.us:         ; preds = %in_bounds-true.us.us.us.1, %in_bounds-after.us.us.us
...
reduce-window.0.loop_exit.window.1:               ; preds = %in_bounds-true.us.us.us.1.1, %in_bounds-after.us.us.us.159, %reduce-window.0.loop_exit.window.3.us.us, %fusion.4.in_bounds-true
